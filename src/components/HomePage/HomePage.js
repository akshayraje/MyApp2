...
class HomePage extends Component {
   ...
   initializeSetupDevice() {
        ...
        OstWalletSdkUI.setThemeConfig(ThemeConfig.theme_config);
        OstWalletSdkUI.setContentConfig(ContentConfig.content_config);
  ...
  onResetPin() {
    ...
    onAddSession(spendingLimit, expiryInDays) {
      this.addSession(spendingLimit, expiryInDays);
    }

    addSession(spendingLimit, expiryInDays) {
      AsyncStorage.getItem('user').then((user) => {
        user = JSON.parse(user);
